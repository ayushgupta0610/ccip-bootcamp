...
export interface CCIPLocalSimulatorForkInterface extends utils.Interface {
  functions: {
...
export interface CCIPLocalSimulatorFork extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CCIPLocalSimulatorForkInterface;
